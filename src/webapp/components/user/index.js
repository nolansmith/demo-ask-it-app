...
export default function User(props) {
    ...
    if (!loading && !data.findUserByUsername) return <Error message="Could not find user" />;
    ...
    return (
        ...
        <div style={{ width: "100%", margin: '20px auto' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '1%', margin: '5% auto', justifyContent: 'center', width: '30%' }} >
                <img style={{ maxHeight: '100px' }} src={`${URLS.images}/single_question.svg`} />
            ...
            <div style={{
                display: 'flex', flexWrap: 'wrap', alignItems: 'flex-start', margin: '1% auto', justifyContent: 'center',
                width: '100%'
            }} className="row">
